...
class TestFetchFoundationModels:
    ...
    def test_fetch_foundation_models_success(
        self,
        bedrock_fetcher: BedrockFetcher,
...
class TestFetchResources:
    ...
    def test_fetch_resources_all_types(
        ...
        mock_paginator_throughput.paginate.return_value = [{'provisionedModelSummaries': []}]
...
class TestErrorHandling:
    ...
    def test_handles_generic_exception(
        ...
        mock_bedrock_client.list_foundation_models.side_effect = Exception("Unexpected error")
